...
/*
  ...
  @param array    - apontador para arranjo
*/
void fprint_int_array_a(char *filename, int n, int *array)
{
   // definir dados locais
   int x = 0;
   int y = 0;
...
/*
  ...
  @param array    - arranjo com dados
*/
int fscan_int_array(char filename[], int n, int array[])
{
   // definir dados locais
   int x = 0;
   int y = 0;
...
/*
  ...
  @param array    - arranjo com dados
*/
int n_fscan_int_array(char filename[], int m, int array[])
{
   // definir dados locais
   int n = 0;
   int x = 0;
...
*/
void copy_int_array(int n, int array[], int copy_array[])
{
   // definir dado local
   int x = 0;
   int y = 0;
...
*/
int compare_int_array(int n, int array[], int other[])
{
   // definir dado local
   int x = 0;
   int y = 0;
